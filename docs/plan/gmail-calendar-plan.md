...
## 16. Status and handoff (Gmail threads on timeline)

### Shipped (phases 0–3)

Phases **0–3** are in the tree. Calendar substrate was already present; this
lane locks **Gmail threads on the record timeline** without auto-create.
