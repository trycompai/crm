...
| `AI_GATEWAY_API_KEY` | Dedicated, capped Gateway credential. Required to open model spend in every environment |
| `VERCEL_OIDC_TOKEN` | Provider-injected Gateway auth. It does not open the spend gate by itself |
