...
export const AGENT_TOOLS = [
	...
	"read_deal_history",
	"read_granola_note",
	"read_outreach_assignment",
	"read_prospect",
	"record_customer_onboarding_plan",
	"record_discovered_prospects",
	"record_fact",
	"record_job_change",
	"record_outreach_sequence",
	"record_prospect_research",
	"research_company",
	"research_person",
