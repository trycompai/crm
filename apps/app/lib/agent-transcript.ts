...
const VERBS: Record<string, string> = {
	...
	discover_prospects: "Looked for new prospects",
	read_prospect_candidate: "Read the prospect and supporting evidence",
	write_prospect_draft: "Drafted a prospect email for review",
